...
func (m *MockiAccountRepository) Create(dto *AccountUnspecifiedDTO) (*AccountDTO, error) {
	m.ctrl.T.Helper()
...
func (mr *MockiAccountRepositoryMockRecorder) Create(dto any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockiAccountRepository)(nil).Create), dto)
}
